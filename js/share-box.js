...
TAAG.shareBox = (function() {
    var me = {},
        ...
        isShown = false,
        rootUrl = "http://r333t.com/software/taag/",
    ...
    twitterWidget.innerHTML = "<a href=\"https://twitter.com/share\" class=\"twitter-share-button\" data-url=\"http://r333t.com/software/taag/\" data-via=\"r333t\">Tweet</a>";
    var googleWidget = document.createElement("div");
    googleWidget.innerHTML = "<div class=\"g-plusone\" data-size=\"small\" data-href=\"http://r333t.com/software/taag/\"></div>";
    ...
    me.show = function() {
        ...
        if (facebookLoaded === false) {
            facebookWidget.innerHTML = "<iframe src=\"//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fr333t.com%2Fsoftware%2Ftaag%2F&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21&amp;appId=142730955792936\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:100px; height:21px;\" allowTransparency=\"true\"></iframe>";   
        }
